...
function sortMethod() {
  ...
  let sortDecrescente = req4decrscente.sort(sort(a,b)=>b-a) //Seu código aqui, manipule a variável sem alterar o nome dela.
...
function conditionCase() {
  //Seu código aqui, descomente para usar a estrutura declarada.
/if () {
    let index => 20; index => historicoDeResultado.length; index++}
